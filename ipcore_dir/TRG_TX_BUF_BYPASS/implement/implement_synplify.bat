...
COPY trg_tx_buf_bypass_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\trg_tx_buf_bypass_top.ucf -p xc6vlx130t-ff1156-1 trg_tx_buf_bypass_top.edf trg_tx_buf_bypass_top.ngd
