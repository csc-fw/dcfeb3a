...
xst -ifn xst.scr
copy clkadj_fine_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clkadj_fine.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkadj_fine.ucf clkadj_fine_exdes

echo 'Running map'
map -timing -pr b clkadj_fine_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm clkadj_fine_exdes -w routed.ncd routed.v
cd ..
