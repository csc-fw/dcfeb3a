...
xst -ifn xst.scr
copy clkadj_coarse_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clkadj_coarse.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkadj_coarse.ucf clkadj_coarse_exdes

echo 'Running map'
map -timing -pr b clkadj_coarse_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm clkadj_coarse_exdes -w routed.ncd routed.v
cd ..
