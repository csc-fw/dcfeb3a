...
COPY daq_gtx_dual_rate_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\daq_gtx_dual_rate_top.ucf -p xc6vlx130t-ff1156-1 daq_gtx_dual_rate_top.edf daq_gtx_dual_rate_top.ngd
