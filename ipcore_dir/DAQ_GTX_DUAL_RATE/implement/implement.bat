...
COPY daq_gtx_dual_rate_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\daq_gtx_dual_rate_top.ucf -p xc6vlx130t-ff1156-1 daq_gtx_dual_rate_top.ngc daq_gtx_dual_rate_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx130t-ff1156-1 -o mapped.ncd daq_gtx_dual_rate_top.ngd
...
netgen -ofmt verilog -sim -dir . -tm daq_gtx_dual_rate_top -w routed.ncd routed.v
