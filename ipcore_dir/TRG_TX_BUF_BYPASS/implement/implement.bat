...
COPY trg_tx_buf_bypass_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\trg_tx_buf_bypass_top.ucf -p xc6vlx130t-ff1156-1 trg_tx_buf_bypass_top.ngc trg_tx_buf_bypass_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx130t-ff1156-1 -o mapped.ncd trg_tx_buf_bypass_top.ngd
...
netgen -ofmt verilog -sim -dir . -tm trg_tx_buf_bypass_top -w routed.ncd routed.v
