...
-- /___/   /\     Timestamp: Tue Jun 18 10:44:11 2013
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -w -sim -ofmt vhdl C:/Users/bylsma/Projects/DCFEB/firmware/dcfeb_f3.0/ipcore_dir/tmp/_cg/CSP_deser_cntrl.ngc C:/Users/bylsma/Projects/DCFEB/firmware/dcfeb_f3.0/ipcore_dir/tmp/_cg/CSP_deser_cntrl.vhd 
-- Device	: xc6vlx130t-ff1156-1
-- Input file	: C:/Users/bylsma/Projects/DCFEB/firmware/dcfeb_f3.0/ipcore_dir/tmp/_cg/CSP_deser_cntrl.ngc
-- Output file	: C:/Users/bylsma/Projects/DCFEB/firmware/dcfeb_f3.0/ipcore_dir/tmp/_cg/CSP_deser_cntrl.vhd
-- # of Entities	: 1
-- Design Name	: CSP_deser_cntrl
...
architecture STRUCTURE of CSP_deser_cntrl is
...
begin
  ...
  CONTROL0(1) <= CONTROL3(1);
  CONTROL0(0) <= CONTROL3(0);
  CONTROL1(2) <= CONTROL3(2);
  CONTROL1(1) <= CONTROL3(1);
  CONTROL1(0) <= CONTROL3(0);
  CONTROL2(2) <= CONTROL3(2);
  CONTROL2(1) <= CONTROL3(1);
  CONTROL2(0) <= CONTROL3(0);
  XST_VCC : VCC
    port map (
      P => N0
    );
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O12 : LUT6
    ...
    port map (
      ...
      I5 => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O1,
