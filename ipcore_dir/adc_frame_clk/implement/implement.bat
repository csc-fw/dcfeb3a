...
xst -ifn xst.scr
copy adc_frame_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\adc_frame_clk.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc adc_frame_clk.ucf adc_frame_clk_exdes

echo 'Running map'
map -timing -pr b adc_frame_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm adc_frame_clk_exdes -w routed.ncd routed.v
cd ..
